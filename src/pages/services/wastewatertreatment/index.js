          ...
          <h3>تصفیه فاضلاب</h3>
            ...
            <div className={styles.balanceItem}>
              <div>
                ...
                <Link href="/services/wastewatertreatment/urbanWasteWater"> تصفیه فاضلاب شهری</Link>
              </div>
              <div>
                <Image
                  className={styles.imgBorder}
                  ...
                  height={100}
                />
                <Link href="/services/wastewatertreatment/IndustrialWastewater"> تصفیه فاضلاب صنعتی</Link>
